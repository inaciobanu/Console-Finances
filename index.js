...
var monthlyChangeMinMax = 0;
//declaring initial max and min value for monthly profit or loss
...
for (var i = 0; i < finances.length - 1 ; i++) {
    ...
    if (monthlyChangeMinMax > max) {
        max = monthlyChangeMinMax;
        maxMonth = finances[i+1][0];
    };
    if (monthlyChangeMinMax < min) {
        min = monthlyChangeMinMax;
